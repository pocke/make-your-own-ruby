...
この会場にはCRuby, mruby, Spinel, PicoRubyの作者がいるらしい。パーサーギャングもいるらしい
...
"キーボードは実質Ruby”、角谷さんによる言葉だと言うことを、この発表の準備をしてて知りました
...
ご清聴ありがとうございました。
キートップ、Rubyの実物は持ってきています！懇親会(本会場)で声をかけてね💎
